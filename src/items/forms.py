...
class ItemModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
          ...
          'shortDesc': forms.Textarea(attrs={'class': 'form-control custom-class'}),
          'longDesc': forms.Textarea(attrs={'class': 'form-control custom-class'}),
        ...
        labels = {
            ...
            "thumb": mark_safe("<strong>Thumbnail</strong>"),
